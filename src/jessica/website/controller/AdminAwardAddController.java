...
/**
 * Servlet implementation class AdminAwardAddController
 */
public class AdminAwardAddController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminAwardAddController() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean is_success = awardDao.addAward(awardname, title,year);
		if (is_success) {
